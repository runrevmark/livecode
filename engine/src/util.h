...
//
// The library parameter can be one of:
//     - an absolute path
//     - a relative path
//     - a filename prefixed by $
//
...
//
// If the library is not prefixed by $ then the library is resolved using the
// internal native code path for the current engine.
//
// If the library is prefixed by $ then the library is loaded using system
