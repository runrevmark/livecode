...
void MCTileCacheInsertScenery(MCTileCacheRef self, MCTileCacheLayerId before_layer_id, const MCRectangle32& region);
// The given scenery layer touching the given region has been removed.
void MCTileCacheRemoveScenery(MCTileCacheRef self, MCTileCacheLayerId layer_id, const MCRectangle32& region);
// The given scenery layer has been reshaped from the old region to the new region.
void MCTileCacheReshapeScenery(MCTileCacheRef self, MCTileCacheLayerId layer_id, const MCRectangle32& old_region, const MCRectangle32& new_region);
// The given scenery layer has changed within the given region.
void MCTileCacheUpdateScenery(MCTileCacheRef self, MCTileCacheLayerId layer_id, const MCRectangle32& region);

// The given sprite has been removed.
void MCTileCacheRemoveSprite(MCTileCacheRef self, MCTileCacheLayerId layer_id);
// The given sprite has changed within the given region.
void MCTileCacheUpdateSprite(MCTileCacheRef self, MCTileCacheLayerId layer_id, const MCRectangle32& region);
// The given sprite's cached tiles are scrolled by the given amount.
void MCTileCacheScrollSprite(MCTileCacheRef self, MCTileCacheLayerId layer_id, int32_t dx, int32_t dy);
